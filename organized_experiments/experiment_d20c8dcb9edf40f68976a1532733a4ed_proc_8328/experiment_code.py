...
scaler_x.fit(train_data[["Age", "Exercise", "Cholesterol", "Medication"]])
train_data_scaled = train_data.copy()
val_data_scaled = val_data.copy()
train_data_scaled[["Age", "Exercise", "Cholesterol", "Medication"]] = (
    scaler_x.transform(train_data[["Age", "Exercise", "Cholesterol", "Medication"]])
)
val_data_scaled[["Age", "Exercise", "Cholesterol", "Medication"]] = scaler_x.transform(
    val_data[["Age", "Exercise", "Cholesterol", "Medication"]]
)
...
train_dataset = prepare_tensor_data(train_data_scaled)
val_dataset = prepare_tensor_data(val_data_scaled)
...
# Hyperparameter tuning: experimenting with different learning rates
...
for lr in learning_rates:
    ...
    model.eval()
    treated_group = train_data_scaled[train_data_scaled["Medication"] == 1]
    control_group = train_data_scaled[train_data_scaled["Medication"] == 0]
...
experiment_data["min_max_scaling"] = results
