...
experiment_data = {"hidden_layer_width_reduction": {}}
...
# Define ablation network with reduced hidden layer widths
class PredictorReduced(nn.Module):
    def __init__(self, input_dim):
        super(PredictorReduced, self).__init__()
...
for lr in learning_rates:
    model = PredictorReduced(input_dim=4).to(device)
    ...
    experiment_data["hidden_layer_width_reduction"][f"lr_{lr}"] = results
